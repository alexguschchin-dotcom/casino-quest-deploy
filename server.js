...
const taskTemplates = [
  ...
  { difficulty: 1, texts: [
    ...
    'Сделать 10 спинов в любом слоте «Рыбак» (ставка от 1000₽)',
    ...
    'Поставить 30 000₽ на 5 и 20 000₽ на 10 в Crazy Time'
  ]},
  
  // ⭐⭐ 2 звезды (60 заданий)
  { difficulty: 2, texts: [
    'Поставить 30 000₽ в Crazy Time',
    ...
    'Поставить 50 000₽ на любое число в рулетке',
    'Сыграть 20 спинов в Dead or Alive 2 по 2000₽',
    'Выдать 10 000₽ одному зрителю',
    'Купить бонус в Big Bass Bonanza за 40 000₽',
  ...
  { difficulty: 3, texts: [
    ...
    'Купить два бонуса в Hot Fiesta за 50 000₽ один должен быть окупной',
    ...
    'Поймать множитель x25 в Sweet Bonanza',
    'Поставить 100 000₽ в рулетке',
    'Выбить бонус в le king за 40 спинов ставка от 2к'
  ]},
  ...
  { difficulty: 4, texts: [
    ...
    'Специальный пропуск: можно пропустить одно задание (активируется автоматически)',
    ...
    'Купить бонус в Dead or Alive 2 за 200 000₽ она должна дать минимум половину',
    'Сделать ставку 200 000₽ в лайв-игре',
    'Купить бонус в Dog House Multihold за 200 000₽ и окупиться',
    'Выиграть х200 в любом слоте с первой попытки',
...
function drawCards(pool, n, level) {
  ...
  if (level % 10 === 0) {
    ...
    if (hard.length >= n) {
      ...
      // Если недостаточно, добираем из остальных
